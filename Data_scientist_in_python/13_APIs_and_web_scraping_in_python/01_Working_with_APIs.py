...
# Set up the parameters we want to pass to the API. This is the latitude and longitude of New York
# City.
...
# Convert fast_food_franchise_string back to a dictionary
