...
killed_non_eq = killed.loc[killed_mask]
...
killed['total_killed']= killed['total_killed'].mask(killed['total_killed'].isnull(),
                                                    killed_manual_sum)
killed['total_killed'] = killed['total_killed'].mask(killed['total_killed'] != killed_manual_sum,
                                                     np.nan)
...
injured['total_injured'] = injured['total_injured'].mask(injured['total_injured'].isnull(),
                                                         injured_manual_sum)
injured['total_injured'] = injured['total_injured'].mask(injured['total_injured'] != injured_manual_sum,
                                                         np.nan)
...
for v in range(1,6):
    ...
    v_missing_mask = mvc[v_col].isnull() & ~mvc[c_col].isnull()
    c_missing_mask = ~mvc[v_col].isnull() & mvc[c_col].isnull()
